...
var {Text,View,TextInput,TouchableWithoutFeedback,Image,ToastAndroid,Platform,Navigator} = React;




class LoginScreen extends React.Component {
    CustomSettingForPlatform(){
        if(Platform.OS === 'ios'){
           //return '{() => VibrationIOS.vibrate()}'
            alert('Somethinf');
            return
        }
        else{
    ...
    render() {
        ...
        <TouchableWithoutFeedback  onPress={this.CustomSettingForPlatform.bind(this)}><View style={styles.loginButton}  ><Text style={styles.loginButtonText}>Smit is smart</Text></View></TouchableWithoutFeedback>
